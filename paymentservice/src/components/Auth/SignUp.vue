                    ...
                    <div>
                        <ul class="cross">
                            <li class="list"><img src="../../assets/list.svg" alt="" srcset="">
                                <p class="ml-4">Start receiving payments with developer-friendly APIs or choose single
                                    string low-code or choose pre-built solutions from our store.</p>
                            </li>
                            <li class="list"><img src="../../assets/list.svg" alt="" srcset="">
                                <p class="ml-4">Account Supports any business model including individual payments and
                                    receivables.</p>
                            </li>
                            <li class="list"><img src="../../assets/list.svg" alt="" srcset="">
                                <p class="ml-4">Online sales, POS, Agent banking, E-commerce, subscriptions, SaaS
                                    platforms, marketplaces, and more—all with one account.</p>
                            </li>
                        </ul>
                        <div class="join">
                            <p>Join thousands of businesses and individuals both startups, enterprises and corporates
                                that trust Appmart.</p>
                        </div>
                        <!-- {{checkbox}} -->
                    </div>
                </div>
        ...
        signIn() {
            if (this.password == '' || this.username == '' || this.middlename == '' || this.firstname == '' || this.phoneNo == '' || this.email == '' || this.lastname == '') {
                ...
                auth.post('/signup', data).then(response => {
                    ...
                    //         width: 500,
                    //     })
                    // } else if (response.data.code == 'e102') {
                    //     Swal.fire({
                    //         icon: 'error',
                    //         title: 'Unsuccessful..',
                    //         text: `${response.data.message}`,
                    //         width: 500,
                    //     })
                    // } else if (response.data.code == 's101') {
                    //     Swal.fire({
                    //         icon: 'success',
                    //         title: 'Successful',
